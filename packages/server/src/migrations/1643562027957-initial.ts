...
export class initial1643562027957 implements MigrationInterface {
    name = 'initial1643562027957'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "post_url" character varying NOT NULL, "user_id" uuid NOT NULL, "caption" text, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "follow" ("user_id" uuid NOT NULL, "follower_id" uuid NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_73979c996d79bdacaee826a3772" PRIMARY KEY ("user_id", "follower_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "User" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "avatar" character varying, "has_avatar" boolean NOT NULL DEFAULT false, "website" character varying, "bio" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_4a257d2c9837248d70640b3e36e" UNIQUE ("email"), CONSTRAINT "UQ_29a05908a0fa0728526d2833657" UNIQUE ("username"), CONSTRAINT "PK_9862f679340fb2388436a5ab3e4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "bookmark" ("user_id" uuid NOT NULL, "post_id" uuid NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_9835db6ee07225b1b2fad9943e5" PRIMARY KEY ("user_id", "post_id"))`);
        await queryRunner.query(`CREATE TABLE "conversation" ("message_id" uuid NOT NULL, "user_id" uuid NOT NULL, "receiver_id" uuid NOT NULL, CONSTRAINT "PK_9a44ed689d9a2fea051c3160f85" PRIMARY KEY ("message_id", "user_id", "receiver_id"))`);
        await queryRunner.query(`CREATE TABLE "like" ("user_id" uuid NOT NULL, "post_id" uuid NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_3221edd468ef18cc93a806b74b2" PRIMARY KEY ("user_id", "post_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "bookmark" ADD CONSTRAINT "FK_88d15be9a11888c73c7328a32fc" FOREIGN KEY ("post_id") REFERENCES "post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "conversation" ADD CONSTRAINT "FK_2f8286c3560b52dba8428ac182e" FOREIGN KEY ("message_id") REFERENCES "message"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "conversation" DROP CONSTRAINT "FK_2f8286c3560b52dba8428ac182e"`);
